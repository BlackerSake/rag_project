...
# 流式输出函数
def run_chat_stream(user_input: str, thread_id: str = "default"):
    """流式运行聊天"""
    logger.info(f"开始流式聊天，用户输入: '{user_input}', thread_id: '{thread_id}'")
    ...
    logger.info(f"流式聊天结束，响应: '{assistant_response[:50]}...', 主题: '{result['current_topic']}', thread_id: '{thread_id}'")
